...
#       example.
vt_default_red=0x10,0xaa,0x00,0xaa,0x00,0xaa,0x00,0xaa,0x55,0xff,0x55,0xff,0x55,0xff,0x55,0xff
vt_default_grn=0x1a,0x00,0xaa,0x55,0x00,0x00,0xff,0xaa,0x55,0x55,0xff,0xff,0x55,0x55,0xff,0xff
vt_default_blu=0x20,0x00,0x00,0x00,0xaa,0xaa,0xc8,0xaa,0x55,0x55,0x55,0x55,0xff,0xff,0xff,0xff
...
menuentry "$SYSNAME" {
	...
	linux /boot/vmlinuz vt.color=0x03 vt.default_red=$vt_default_red vt.default_grn=$vt_default_grn vt.default_blu=$vt_default_blu
	echo "Loading initrd..."
