...
menuentry "$SYSNAME" {
	...
	linux /boot/vmlinuz vt.color=0x0B vt.default_red=$vt_default_red vt.default_grn=$vt_default_grn vt.default_blu=$vt_default_blu sigmamodules=$INITRAMFS_MODPROBE
	echo "Loading initrd..."
